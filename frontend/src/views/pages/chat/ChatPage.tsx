                ...
                return (
                  <div 
                    ...
                    className={`flex items-center p-4 cursor-pointer hover:bg-gray-50 transition-colors border-b border-gray-100 ${
                      activeRoom?.room_id === room.room_id ? 'bg-[#edfef0]' : ''
                    }`}
                  >
                   ...
                   <div className="space-y-4">
                     ...
                     {[1, 2, 3, 4, 5].map((i) => (
                       <div key={i} className={`flex w-full ${i % 2 === 0 ? 'justify-end' : 'justify-start'}`}>
                         <div className={`max-w-[75%] px-4 py-3 rounded-2xl ${i % 2 === 0 ? 'bg-[#c8f0ca]' : 'bg-gray-200'} animate-pulse`}>
                      ...
                      <div key={idx} className={`flex w-full ${isMe ? 'justify-end' : 'justify-start'}`}>
                        ...
                        <div 
                          className={`
                            ...
                            ${isMe 
                              ? 'bg-[#42b549] text-white rounded-tr-none' 
                        ...
                        >
                          ...
                          {msg.message_type === 'image' ? (
                            ...
                            <div className="bg-white rounded-lg p-3 max-w-[250px] border border-gray-200">
                                ...
                                {(msg as any).product_price && (
                                  <p className="text-[#42b549] font-bold text-sm">
                                ...
                                {msg.product_id && (
                                  <a 
                                    ...
                                    className="inline-block mt-2 text-xs text-[#42b549] hover:underline"
                                  >
                                    Lihat Produk →
                                  </a>
                                )}
                          ...
                          {/* Info Waktu & Status */}
                          <div className={`text-[10px] mt-1 flex items-center gap-1 ${isMe ? 'justify-end text-[#99d99c]' : 'justify-start text-gray-400'}`}>
                             <span>{formatTimeAgo(msg.created_at)}</span>
                             {isMe && (
                                <span>
                                   {msg.is_read ? (
                                      <span className="text-[#66d19c]">✓✓</span>
                                   ) : (
                                      <span className="text-[#99d99c]">✓</span>
                                   )}
                                </span>
                             )}
                          </div>
                          ...
                          searchProducts.map((product) => (
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <p className="text-xs text-[#42b549] font-bold">Rp {Number(product.price).toLocaleString('id-ID')}</p>
                              </div>
                            </div>
                          ))
                        ) : (
