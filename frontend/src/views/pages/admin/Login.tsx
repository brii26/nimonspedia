...
const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#42b549] to-[#217a28] p-4">
      <section className="w-full max-w-md bg-white rounded-xl shadow-2xl p-8">
        ...
        <nav className="mt-6 text-center">
          <p>
            <a href="/" className="text-[#42b549] hover:text-[#2d8f34] font-medium transition-colors inline-flex items-center gap-1">
              ← Back to Main Site
            </a>
          </p>
        </nav>
