  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card><CardHeader><CardTitle>Total Users</CardTitle></CardHeader><CardBody><div className="text-4xl font-bold text-[#42b549]">{stats.totalUsers}</div></CardBody></Card>
        <Card><CardHeader><CardTitle>Buyers</CardTitle></CardHeader><CardBody><div className="text-4xl font-bold text-[#42b549]">{stats.totalBuyers}</div></CardBody></Card>
      ...
      <Modal isOpen={showFlagsModal} onClose={() => setShowFlagsModal(false)} size="lg">
        ...
        <ModalBody>
          <div className="space-y-6">
            <div className="bg-[#edfef0] border-l-4 border-[#42b549] p-4 rounded">
              <p className="text-[#1a5c1f] text-sm"><strong>User:</strong> {selectedUser?.email}</p>
            </div>
