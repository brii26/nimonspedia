...
const AuctionDetail = () => {
  ...
  const getStatusColor = () => {
      switch(auction.status) {
          ...
          case 'scheduled': return 'text-[#42b549] bg-[#edfef0] border-[#99d99c]';
      ...
      <div className="bg-white border-b sticky top-0 z-20">
          <div className="container mx-auto px-4 py-3 flex items-center justify-between">
            <button 
              ...
              className="text-gray-500 hover:text-[#42b549] flex items-center gap-2 text-sm font-medium transition-colors"
            >
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-500 mb-6">
                        <div className="flex items-center gap-1">
                            ...
                            <span className="font-medium text-gray-900 hover:text-[#42b549] cursor-pointer transition-colors">
                                        ...
                                        return (
                                            <tr key={idx} className={`hover:bg-gray-50 transition-colors ${idx === 0 ? 'bg-green-50/60' : ''}`}>
                                                <td className="px-6 py-3 font-medium text-gray-900">
                                                    <div className="flex items-center gap-2">
                                                        <div className={`w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold ${isMe ? 'bg-[#42b549] text-white' : 'bg-gray-200 text-gray-600'}`}>
                                                        ...
                                                        {isMe && <span className="text-[10px] bg-[#c8f0ca] text-[#2d8f34] px-1.5 py-0.5 rounded font-bold border border-[#99d99c]">YOU</span>}
                                                    </div>
                                                </td>
                ...
                <div className="sticky top-24 space-y-6">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden relative">
                        <div className={`h-2 w-full ${
                            ...
                            auction.status === 'scheduled' ? 'bg-gradient-to-r from-[#42b549] to-[#217a28]' :
                            'bg-gray-300'
                        }`}></div>
                        ...
                        <div className="p-6">
                            ...
                            <div className="text-center mb-8">
                                ...
                                <div className={`text-5xl font-mono font-bold tracking-tighter ${
                                    ...
                                    auction.status === 'active' ? 'text-gray-900' : 'text-[#42b549]'
                                }`}>
                                    {displayTime}
                                </div>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input 
                                            ...
                                            className="w-full pl-10 pr-4 py-4 bg-white border border-gray-200 rounded-xl text-lg font-bold text-gray-900 placeholder-gray-300 focus:ring-2 focus:ring-[#42b549] focus:border-transparent outline-none transition-all shadow-sm"
                                            placeholder="0"
                                        />
                                    </div>
                                    ...
                                    <Button 
                                        ...
                                        disabled={!canBid}
                                        variant="primary"
                                        className="w-full py-4 text-lg shadow-lg hover:shadow-xl shadow-[#42b549]/30"
                                    >
                                        Place Bid Now
                                    </Button>
					...
					{stoppedBySeller && !isSeller ? (
						...
						<div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 space-y-3">
							<div className="flex items-start gap-3">
									<div className="w-8 h-8 rounded-full bg-[#edfef0] flex items-center justify-center flex-shrink-0 text-[#42b549]">
