    ...
    checkoutBtn.addEventListener('click', (e) => {
        ...
        const onConfirm = () => {
            ...
            .then(response => {
                ...
                if (result.json) {
                    if (result.json.redirect) { window.location = result.json.redirect; return; }
                    if (result.json.success) { window.location = '/orders'; return; }
                ...
                if (window.App && typeof window.App.showAlert === 'function') {
                    window.App.showAlert('Terjadi kesalahan saat melakukan checkout.', 'error');
                } else {
