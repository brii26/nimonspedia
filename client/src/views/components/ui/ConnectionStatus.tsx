...
type ConnectionStatusType = 'connected' | 'connecting' | 'disconnected' | 'reconnecting';
...
const ConnectionStatus: React.FC<ConnectionStatusProps> = ({ 
  ...
  const statusConfig: Record<ConnectionStatusType, { bgColor: string; text: string; textColor: string }> = {
    connected: {
